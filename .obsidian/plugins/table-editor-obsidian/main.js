...
var TableEditorPlugin = /** @class */ (function (_super) {
    ...
    TableEditorPlugin.prototype.enableMonospaceFont = function () {
        console.log('Advanced Tables: Adding css class to enable monospace font in tables');
